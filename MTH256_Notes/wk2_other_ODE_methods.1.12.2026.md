...
If we assume perfect mixing, $C_{out}  = \frac{y(t)}{V(t)} = \frac{y(t)}{V_0}$
...
This is a linear problem because $\frac{dy}{dt}$ shows up by itself. Linear, non-separable, non-constant coefficients. Only method available is integrating factor.

Thus $\mu(t) = e^{\int \frac{11}{200-t}dt} = e ^{-11 ln(t - 200)} = e ^{ln(t - 200)^{-11}}$
$\mu(t)=\frac{1}{(t-200)^{11}}$

So, the equation is:
$$\mu(t)(\frac{dy}{dt} + \frac{11y}{200-t}) = \mu(t)(\frac{5}{2}) \to \int[\frac{d}{dt}(t - 200)^{-11}] dt = \int\frac{5(t - 200)^{-11}}{2}dt $$
$$(t - 200)^{-11}y= \frac{-5}{20(t - 200)^{10}} + C$$
$$y = \frac{-5}{20}(t-200) + C(t-200)^{11}$$
$$y(0) = 0 = \frac{-5}{20}(-200) + C(200)^{11}\to C = \frac{-50}{200^{11}}$$
$$y(t) = \frac{200 - t}{4} + \frac{-50(t - 200)^{11}}{200^{11}}$$
$$y(t) = \frac{200 - t}{4} + \frac{50(200 - t)^{11}}{200^{11}}$$
