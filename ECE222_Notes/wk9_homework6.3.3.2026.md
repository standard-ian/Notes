...
$$H(s) = \frac{\frac{1}{10^{-8}s}}{50000 + \frac{1}{10^{-8}s}} = \frac{\frac{1}{10^{-8}s}}{50000 + \frac{1}{10^{-8}s}} \cdot\left(\frac{10^{-8}s}{10^{-8}s}\right) = \frac{1}{5\times10^4\times10^{-8}s + 1}$$
...
\begin{circuitikz}[american, scale=2, font=\Large]
	...
	to[switch]++(1,0)
	to[R=$6\Omega$]++(2,0)
	to[capacitor, l=$\frac{1}{3}F$]++(0,-2)++(0,2)--++(2,0)
	node[ocirc, label=right:$V_2$]{}++(-1,0)
	to[R=$6\Omega$]++(0,-2)--++(-4,0);
...
\begin{circuitikz}[american, scale=2, font=\Large]
	...
	to[vsource, invert, V=$V_1$]++(0,2)
	to[switch]++(1,0)
	to[capacitor, l=$0.5F$]++(1,0)
	to[inductor, l=$1H$]++(1,0)--++(1,0)
	node[ocirc, label=right:$V_2$]{}++(-1,0)
